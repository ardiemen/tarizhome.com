(function($) {
	...
	function headerStick() {
		if($('.header-lower').length && $('.header-lower').data('stick') ){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.header-lower');
			var scrollLink = $('.scroll-to-top');

			var HeaderHight = $('.header-lower').height();
			if (windowpos >= HeaderHight) {
				siteHeader.addClass('stick');
				siteHeader.find('.logo-dark').hide()
				siteHeader.find('.logo-light').show()
				scrollLink.fadeIn(300);
			} else {
				siteHeader.removeClass('stick');
				siteHeader.find('.logo-dark').show()
				siteHeader.find('.logo-light').hide()
				scrollLink.fadeOut(300);
			}
	...
	// JSn Service carousel
	if ($('.jsn-service-carousel').length) {
		$('.jsn-service-carousel').owlCarousel({
			loop: false,
			margin: 30,
			// stagePadding: 10,
			nav: true,
	...
	// JSn Service carousel
	if ($('.jsn-news-carousel').length) {
		$('.jsn-news-carousel').owlCarousel({
			loop: false,
			margin: 10,
            // autoWidth: true,
			nav: true,
	...
	if ($('.jsn-client-carousel').length) {
		$('.jsn-client-carousel').owlCarousel({
			rtl: true,
			loop: true,
			margin: 30,
			nav: false,
	...
	if ($('.swiper-client').length){
		let ClientSwiper = new Swiper('.swiper-client', {
			spaceBetween: 20,
			centeredSlides: true,
			speed: 6000,
			autoplay: {
	...
	// Swiper Gallery
	if ($('.swiper-gallery-top').length){
		let SwiperTop = new Swiper('.swiper-gallery-top', {
			spaceBetween: 15,
			centeredSlides: true,
			speed: 6000,
			autoplay: {
	...
	// Swiper Gallery
	if ($('.swiper-gallery-bottom').length){
		let SwiperBottom = new Swiper('.swiper-gallery-bottom', {
			spaceBetween: 15,
			centeredSlides: true,
			speed: 6000,
			autoplay: {
	...
	// Partner Item Carousel
	if ($('.jsn-partner-carousel').length) {
		$('.jsn-partner-carousel').owlCarousel({
			loop:true,
			margin:30,
			nav:true,
			smartSpeed: 500,
